Our 2nd project for the AED classes \begin{DoxyVerb}             /############.                                                                     
         ,####################                                                                  
       /#####(            ######.                                                               
      #####                 .#####                                                              
  .*******.                  /#######            #######(  #########/   (########  #########    
      ...
      *****.                ,****,                                                              
       .******            ******                                                                
          ********************                                                                  
              ***********.                                                                      
\end{DoxyVerb}
 \hypertarget{md__c___users__francisco__prada__c_o_p_y__o_f__a_e_d__s_t_c_p__r_e_a_d_m_e_autotoc_md1}{}\doxysubsection{Requisitos mínimos\+:}\label{md__c___users__francisco__prada__c_o_p_y__o_f__a_e_d__s_t_c_p__r_e_a_d_m_e_autotoc_md1}
\begin{DoxyVerb}• Ler dados fornecidos no dataset.zip e criar um ou mais gafos (que serão alvos de operações)
